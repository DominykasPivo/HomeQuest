"""
Django settings for HomeQuest project.
...
SECRET_KEY = 'django-insecure-&ia06j637b9n0#h=c^80^4*^!c1@(f3##7_kvx2==xmu%8yv3)'
...
if DEBUG:
    STATICFILES_DIRS.append(BASE_DIR / "myapp" / "static")
